...
namespace NeoTagger.Controllers
{
    public class TagsController : Controller
    {
        ...
        public TagsController(NeoTaggerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,Name,Lat,Lng,Public,Archived,InsertedAt")] Tag tag)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,Name,Lat,Lng,Public,Archived,InsertedAt")] Tag tag)
        {
            if (id != tag.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NeoTaggerContext.Tag'  is null.");
            }
            var tag = await _context.Tag.FindAsync(id);
            if (tag != null)
            {
